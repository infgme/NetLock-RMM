...
namespace Windows.Microsoft_Defender_Firewall
{
    internal class Handler
    {
        ...
        public static void NetLock_RMM_Comm_Agent_Rule_Outbound()
        {
            ...
            {
                Logging.Error("Microsoft_Defender_Firewall.NetLock_RMM_Comm_Agent_Rule_Outbound", "Add NetLock service rule (outbound)", ex.Message);
            }
        }
        ...
        public static void NetLock_RMM_Comm_Agent_Rule_Inbound()
        {
            ...
            {
                Logging.Error("Microsoft_Defender_Firewall.NetLock_RMM_Comm_Agent_Rule_Inbound", "Add NetLock service rule (inbound)", ex.Message);
            }
        }
        ...
        public static void NetLock_RMM_Health_Service_Rule()
        {
            ...
            {
                Logging.Error("Microsoft_Defender_Firewall.NetLock_RMM_Health_Service_Rule", "Add NetLock health service rule", ex.Message);
            }
        }
        ...
        public static void NetLock_Installer_Rule()
        {
            ...
            {
                Logging .Error("Microsoft_Defender_Firewall.NetLock_Installer_Rule", "Add NetLock installer rule", ex.Message);
            }
        }
        ...
        public static void NetLock_Uninstaller_Rule()
        {
            ...
            {
                Logging.Error("Microsoft_Defender_Firewall.NetLock_Uninstaller_Rule", "Add NetLock uninstaller rule", ex.Message);
            }
        }
    }
}
