    ...
    internal class Check_Connection
    {
        public static async Task Check_Servers()
        {
            try
            {
                ...
                List<string> values = new List<string>(Configuration.Agent.remote_servers.Split(','));
                ...
                foreach (var value in values)
                {
                    ...
                    {
                        Remote_Worker.remote_server = value + "/commandHub";
                        Remote_Worker.remote_server_url_command = value;
                        Remote_Worker.remote_server_status = true;
                    ...
                    {
                        Remote_Worker.remote_server_status = false;
                ...
                foreach (var value in values) 
                {
                    ...
                    {
                        Remote_Worker.file_server = value;
                        Remote_Worker.file_server_status = true;
                    ...
                    {
                        Remote_Worker.file_server_status = false;
