...
namespace Global.Initialization
{
    internal class Server_Config
    {
        ...
        /// <summary>
        /// Loads and decrypts the server config JSON. Retries on failure with delay.
        /// </summary>
        private static string LoadAndDecryptConfig()
        {
           try
           {
               ...
               {
                   // File is unencrypted - just return it
                   Logging.Debug("Server_Config", "LoadAndDecryptConfig", "Config file is unencrypted. Loading...");
